...
from SMMusic.core.call import SM
from SMMusic.misc import db
from SMMusic.utils.database import get_loop
from SMMusic.utils.decorators import AdminRightsCheck
...
async def skip(cli, message: Message, _, chat_id):
    ...
    if "live_" in queued:
        ...
        try:
            await SN.skip_stream(chat_id, link, video=status)
        except Exception:
